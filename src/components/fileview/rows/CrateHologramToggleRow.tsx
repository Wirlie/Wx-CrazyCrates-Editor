...
function CrateHologramToggleRow(props: Props) {
    ...
    if(!enableEdit) {
        return (
            <tr>
                <td style={{verticalAlign: "middle", whiteSpace: "nowrap"}}><FontAwesomeIcon icon={faCog} /> <b>{t("crate_editor_hologram_toggle_title")}</b></td>
...
export default CrateHologramToggleRow
