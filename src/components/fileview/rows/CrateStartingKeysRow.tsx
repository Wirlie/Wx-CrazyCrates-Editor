...
function CrateStartingKeysRow(props: Props) {
    ...
    let crateStartingKeys = buildOption(value, (el) => el + " llaves")
    ...
    if(!enableEdit) {
        return (
            <tr>
                <td style={{verticalAlign: "middle", whiteSpace: "nowrap"}}><FontAwesomeIcon icon={faKey} /> <b>Llaves Iniciales:</b></td>
